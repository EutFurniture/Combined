...
export default function UpdateCashOnDelivery() {
 ...
 const [newPayment_status,setNewPayment_status]=useState(0);
  ...
  const UpdateConDelivery = (order_id) => {
    axios.put(`http://localhost:3001/confirmcashondelivery/${order_id}`, {payment_status:newPayment_status, order_id:order_id}).then(
      (response) => {
        setReturnList(Dt.map((record) => {
          return record.id === order_id ? {order_id: record.order_id, payment_status: record.payment_status,  o_status:newPayment_status} : record
        ...
        <div >
           ...
           <Typography component="h1" variant="h6" color="inherit" align="center" width="100%" noWrap className={classes.title}>
              ...
              <Form.Group as={Row} controlId="formHorizontalName">
                  ...
                  <Col >
                  <Form.Control as="select" defaultValue={Dt.payment_status}  onChange={(event)=> { setNewPayment_status(event.target.value);}} >
                 
                      <option value="Completed">Paid</option>
                      <option value="Ready to deliver">Advance Paid</option>
