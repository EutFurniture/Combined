...
// import about from '../../images/homenew.jpg'
import about from '../../images/h24.jpeg'
    ...
    return (
      <Fragment>
        ...
        <div className="about" >
          ...
          <h1 className="p1">WELCOME TO EUT FURNITURE ONLINE STORE!</h1>
         ...
         <div style={{display:'flex',backgroundColor:'#d3d3d3',paddingTop:'20px'}}>
