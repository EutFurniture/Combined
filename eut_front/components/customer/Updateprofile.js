        ...
        (response) => {
          ...
          setEmployeeList(Dt.map((val) => {
            return val.customer_id === customer_id ? {
              customer_id: val.customer_id, fname: val.name, email: val.email, address: val.address, phone: val.phone_no, password: val.password, proimg: val.proimg,
              fname: newName, email: newEmail, address: newAddress, phone_no: newPhone_no, password: newpassword, proimg: newimage
            } : val
