...
export default function CustomerData() {
    ...
    const customer = async () => {
        ...
        const response4 = await axios.get('http://localhost:3001/ReturnItemReport', {
            params: {
               to_date:to_date,  
               from_date:from_date
            }
    ...
    const count1 = deliveryList1.map(record=>record.count);
      ...
      return (
        <div >
         ...
         <div style={{display:'flex',alignItems:'center',backgroundColor:'#dcdcdc',height:'100px'}}>
                   <div>
                  <label style={{marginLeft:'40px',fontSize:'18px'}}>From Date</label>
                  <input type='date' style={{width:'300px',height:'40px',border:'none',backgroundColor:'aliceblue',paddingLeft:'20px',marginTop:'10px',marginLeft:'20px',borderRadius:'10px'}} placeholder='From Date' 
                   onChange={(event)=> {
              ...
              <input type='date' style={{width:'300px',height:'40px',border:'none',backgroundColor:'aliceblue',paddingLeft:'20px',marginTop:'10px',marginLeft:'20px',borderRadius:'10px'}} placeholder='To date' 
                   onChange={(event)=> {
                  ...
                  <h2 style={{marginLeft:'10px',color:'red'}}><b>Customer Details</b></h2>
