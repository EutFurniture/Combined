...
//  const viewOrder = (cus_product_id) => {
//      const response1 =  axios.get('http://localhost:3001/ViewCusOrder', {
//          params: {
...
//                           <Link to={location=> `/CustomView/${record.cus_product_id}`} className="viewbtn" > View </Link>
