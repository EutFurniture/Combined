...
//       axios.put("http://localhost:3001/updateProfile", {name: newName,price:newPrice,material:newMaterial,category_id:newCategory_id,product_img:state.file.name,quantity:newQuantity,product_id: product_id}).then(
//         (response) => {
