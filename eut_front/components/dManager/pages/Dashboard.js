  ...
  const NotificationClick = async () => {
    ...
    if(paymentmesscount>0)
    {
      const customToast=()=>{
        return(
          <div>
            You have New Payment Confirmations from Deliver Person! <br></br>
            <Button variant="light" onClick={Notification_page}>View</Button>
          </div>
        )
      }
      ...
      if(returnmesscount>0)
      {
        const customToasts=()=>{
          return(
            <div>
              You have New Return Delivery Confirmations from Deliver Person! <br></br>
              <Button variant="light" onClick={Notification_page}>View</Button>
            </div>
          )
        }
      ...
      if(ordermesscount>0)
      {
        const customToastse=()=>{
          return(
            <div>
              You have New  Delivery Confirmations from Deliver Person! <br></br>
              <Button variant="light" onClick={Notification_page}>View</Button>
            </div>
          )
        }
      ...
      window.location.href='/dManager/pages/Notification'
      }
