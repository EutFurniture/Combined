...
export default function UpdateReturnItem() {
  ...
  const NotificationClick = async () => {
    ...
    useEffect(() => {
      const fetchData = async () => {
          const response = await axios.get('http://localhost:3001/viewReturnDetails', {
              params: {
                 order_id: order_id,
              }
          });
          setDt(response.data[0]);
          setNewStatus(response.data[0].return_status)
    ...
    const updateReturnStatus = (order_id) => {
      ...
      <main style={{backgroundColor: '#f0f8ff'}} className={classes.content}>
        ...
        <Grid item xs={12}  direction="row"  >
            <div >
              ...
              <strong>UPDATE RETURN STATUS</strong>
              </Typography><br/>
            ...
            <Form>           
              ...
              <div align="center">
              <Button variant="contained" color = "primary" type="submit"   style={{fontSize:'20px',width:'200px'}} onClick={() => {updateReturnStatus(Dt.order_id)}} >Update</Button>
              </div><br/><br/>
            </Form>
