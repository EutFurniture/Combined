...
app.get('/orderproduct', (req, res) => {
  db.query("INSERT INTO orders(customer_id,total_price,advance_price,o_date,status,order_type) VALUES (?,?,?,NOW(),'Pending','Normal');", [req.query.cid, req.query.total, req.query.advance], (err, result) => {
    res.send(result);
...
app.get('/insertpayment', (req, res) => {
  db.query("INSERT INTO payment(payment_method,payment_status,order_id) VALUES ('card','pending',?);", [req.query.oid], (err, result) => {
    res.send(result);
...
app.get('/insertfullpayment', (req, res) => {
  db.query("INSERT INTO payment(payment_method,payment_status,order_id) VALUES ('card','complete',?);", [req.query.oid], (err, result) => {
    res.send(result);
