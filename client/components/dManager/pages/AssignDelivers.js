...
{/*                         
                         <Box style={{ width: '18rem' , borderColor: 'blue', borderWidth: '1px'}}>
                           <p>DELIVER ID : {record.id}</p>
                           <p>Name : {record.name}</p>
                           <p>Deliver Address : {record.e_address}</p>
                           <p>Shipping Address : {record.address}</p>
                           <p>Delivery Date : {dateOnly(record.order_last_date)}</p>
                           <p>Scheduled : {record.pending}</p>
                         </Box> */}
                      </div>
