...
export default function Sales_ViewProfile() {
        ...
        <Container maxWidth="lg" className={classes.container}>
          <Grid container spacing={18}>
            ...
            <div>
              ...
              <Title><h4 align="center"><b>My Profile</b></h4></Title>
              </Typography>
              <br></br>
              ...
              <div style={{width:'300px'}}>
                  <img src={`/${Dt.emp_img}`} className={classes.user1} align='center' alt="Profile Img"></img>

                 <Button href='/Sales_UpdateProfile' style={{color:'white',textDecoration:'none',borderRadius:'10px',backgroundColor:'green',fontSize:'18px',border:'none',width:'200px',marginLeft:'30px'}} >Edit Profile</Button>
